...
from .record import get_full_path_by_frn
...
class DirectoryIdentityCache:
    ...
    def _get_frn_for_path(self, path: str,
        ...
        """
        try:
            # 使用 ctypes 调用 GetFileInformationByHandle
            from .record import (
                kernel32, CreateFileW, CloseHandle,
                GENERIC_READ,
...
# 需要导入 wintypes 用于 BY_HANDLE_FILE_INFORMATION
